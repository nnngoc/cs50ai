...
def shortest_path(source, target):
    ...
    # If node contains the state, here is solution
    ...
    while True:
        ...
        # If node contains target, return find_solution
        ...
        for action, state in neighbours:
            ...
            next = Node(state=state, parent=node, action=action)
            if state == target:
                return find_solution(next)
